...
This ruled out the image as a standalone cause — it requires the reporter's host stack to trigger.
...
| Container | Level-Zero runtime | torch | Result |
|---|---|---|---|
| `intel/llm-scaler-vllm:0.14.0-b8.3.1` | `1.14.37435+12` | `2.10.0+xpu` | ❌ Crashes |
| `intel/vllm:0.10.2-xpu` | `1.6.34666+3` | `2.8.0+xpu` | ✅ No crash |
